...
let
  ...
  testsuite = [
    (import ./cabal-project.nix lib iogx-schemas.cabal-project)
    (import ./haskell.nix lib iogx-schemas.haskell)
    (import ./ci.nix lib iogx-schemas.ci)
    (import ./formatters.nix lib iogx-schemas.formatters)
    (import ./shell.nix lib iogx-schemas.shell)
    (import ./per-system-outputs.nix lib iogx-schemas.per-system-outputs)
    (import ./top-level-outputs.nix lib iogx-schemas.top-level-outputs)
    (import ./read-the-docs.nix lib iogx-schemas.read-the-docs)
  ];

in

l.deepSeq testsuite "success"
