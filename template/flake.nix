...
#   4. Run `nix develop` and read the welcome message
  ...
  outputs = inputs:
    let
      flakeopts = {
        ...
        # In general you want this to be true.
        ...
        # }
        # This field is optional.
        # This field default to a noop, which means: do not add extra haddock
        ...
        # generated by the template.
        # If you want a custom outputs, you should set this value to 
