...
The shells generated by [`mkHaskellProject.<in>.shellArgs`](#mkhaskellprojectinshellArgs) will be augmented with several scripts to make developing your site easier, grouped under the tag `read-the-docs`.
