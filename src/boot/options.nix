    ...
    options = {
      ...
      haskellCompiler = l.mkOption {
        ...
        description = ''
          ...
          IOGX does this automatically when creating a shell with ${link "mkHaskellProject.<in>.shellArgsForProjectVariant"}.
        '';
        example = l.literalExpression ''
          # shell.nix 
          { repoRoot, inputs, pkgs, lib, system }:
    ...
    options = {
      ...
      readTheDocs = l.mkOption {
        ...
        description = ''
          ...
          The shells generated by ${link "mkHaskellProject.<in>.shellArgsForProjectVariant"} will be augmented with several scripts to make developing your site easier, grouped under the tag `read-the-docs`.
          ...
          options = {
            ...
            hydraJobs = l.mkOption {
              ...
              description = ''
                ...
                The `devShell` comes from your implementation of ${link "mkHaskellProject.<in>.shellArgsForProjectVariant"}.
            ...
            devShell = l.mkOption {
              ...
              description = ''
                The `devShell` as provided by your implementation of ${link "mkHaskellProject.<in>.shellArgsForProjectVariant"}.
            ...
            pre-commit-check = l.mkOption {
              type = l.types.package;
              description = ''
                The derivation for the ${link "mkShell.<in>.preCommit"} coming from ${link "mkHaskellProject.<in>.shellArgsForProjectVariant"}.
              '';
            };
          };
        };
