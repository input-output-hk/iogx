...
let
    ...
    options = {
      cabalProject = l.mkOption {
        ...
        description = ''
          ...
          The variants will be available in ${
            link "mkHaskellProject.<out>.variants"
          }.
        '';
        example = l.literalExpression ''
          # nix/project.nix 
      ...
      shellArgs = l.mkOption {
        ...
        description = ''
          ...
          ${
            link "mkHaskellProject.<in>.cabalProject"
          } (coming from `haskell.nix`),
      ...
      includeProfiledHydraJobs = l.mkOption {
        ...
        description = ''
          When set to `true` then ${
            link "mkHaskellProject.<out>.flake"
          } will include:
          ```nix 
      ...
      combinedHaddock = l.mkOption {
        ...
        description = ''
          ...
          When enabled, your ${
            link "mkHaskellProject.<in>.readTheDocs"
          } site will have access to Haddock symbols for your Haskell packages.
  ...
  mkHaskellProject-OUT-submodule = l.types.submodule {
    options = {
      flake = l.mkOption {
        type = l.types.attrs;
        description = ''
          An attribute set that can be included in your ${
          ...
          If you set ${
            link "mkHaskellProject.<in>.includeMingwW64HydraJobs"
          } to `true`, then 
          this attrset will also include `hydraJobs.mingwW64`.

          This also automatically adds the `hydraJobs.required` job using ${
            link "mkHydraRequiredJob"
          }.
          ...
          - `hydraJobs.combined-haddock` = ${
            link "mkHaskellProject.<out>.combined-haddock"
          }
          - `hydraJobs.read-the-docs-site` = ${
            link "mkHaskellProject.<out>.read-the-docs-site"
          } 
          - `hydraJobs.pre-commit-check` = ${
            link "mkHaskellProject.<out>.pre-commit-check"
          } 
          - `hydraJobs.mingwW64` = ${
            link "mkHaskellProject.<out>.cross.mingwW64.hydraJobs"
          } (conditionally)
      ...
      hydraJobs = l.mkOption {
        ...
        description = ''
          ...
          The `devShell` comes from your implementation of ${
            link "mkHaskellProject.<in>.shellArgs"
          }.
          ...
          If you need those you can use ${
            link "mkHaskellProject.<out>.flake"
          }, or you can consume them directly.
        '';
      };
      ...
      devShell = l.mkOption {
        ...
        description = ''
          The `devShell` as provided by your implementation of ${
            link "mkHaskellProject.<in>.shellArgs"
          }.
        '';
      };
      ...
      combined-haddock = l.mkOption {
        ...
        description = ''
          The derivation for your ${
            link "mkHaskellProject.<in>.combinedHaddock"
          }.
        '';
      };
      ...
      pre-commit-check = l.mkOption {
        type = l.types.package;
        description = ''
          The derivation for the ${link "mkShell.<in>.preCommit"} coming from ${
            link "mkHaskellProject.<in>.shellArgs"
          }.
        '';
      };
  ...
  mkHaskellProject = l.mkOption {
    ...
    '';
    type = utils.mkApiFuncOptionType mkHaskellProject-IN.type
      mkHaskellProject-OUT.type;
    example = l.literalExpression ''
      # nix/project.nix 
      { repoRoot, inputs, pkgs, lib, system }:
      lib.iogx.mkHaskellProject {
